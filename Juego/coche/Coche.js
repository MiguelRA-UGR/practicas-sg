...
class Coche extends THREE.Object3D {
    ...
    crearGuardaBarros(){
        ...
        this.piezaGuardaBarrosCSG.subtract([this.piezaGuardaBarros, this.piezaGuardaBarrosHueco, this.cuboHueco]);
        ...
        this.interiorGuardaBarrosCSG.subtract([this.interiorGuardaBarros, this.cuboHueco]);
    ...
    crearParachoques(){
        ...
        const pathParachoques = new THREE.CatmullRomCurve3(parachoquesPoints,false);
        const pathParachoques1 = new THREE.CatmullRomCurve3(parachoquesPoints1,false);
    ...
    crearVolante(){
        ...
        this.unionsoporte = new THREE.Mesh(this.unionsoporteVolanteGeom,this.metalNegro);
        ...
        this.botonVerde = new THREE.Mesh(this.botonVerdeGeom,new THREE.MeshBasicMaterial({ color: 0x00ff00 }));
        ...
        this.botonRojo = new THREE.Mesh(this.botonRojoGeom,new THREE.MeshBasicMaterial({ color: 0xff0000 }));
        ...
        const pathMangoVolante = new THREE.CatmullRomCurve3(mangoVolantePoints, false, 'catmullrom', 0.5);
        const extrudeSettingsMangoVolante = { steps: 100, bevelEnabled: false, extrudePath: pathMangoVolante };
        const mangoVolanteGeom = new THREE.ExtrudeGeometry(this.circleShape, extrudeSettingsMangoVolante);
